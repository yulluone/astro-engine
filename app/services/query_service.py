...
def refine_user_query(
				...
				try:
					...
					**tenant CONTEXT:**
					- Name: {tenant_name}
					- Bio: {tenant_bio}
					- tenant Prompt: This will help you understand the task of the response AI because you are gettign information for them: {tenant_prompt}
			...
			**INSTRUCTIONS:**
					...
					4. 	**Do not include boiler play eg: The User is looking for, The user want. Assume you are giving an answer to, what should I search for to answer this user? What information do I need to answer this query?**
