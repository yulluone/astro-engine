...
from .api.endpoints import tenants, tags, products, webhooks, knowledge
...
app = FastAPI(
    ...
    description="The core API for the Astro multi-channel user engagement platform.",
    version="0.1.0"
)
...
# from .api.endpoints import tenants, products
